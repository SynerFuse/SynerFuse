...
from synerfuse.core.models.bert.bert_layer_specs import bert_layer_with_transformer_engine_spec, bert_layer_local_spec
from synerfuse.core.datasets.blended_megatron_dataset_builder import BlendedMegatronDatasetBuilder
from synerfuse.core.datasets.bert_dataset import BERTMaskedWordPieceDataset, BERTMaskedWordPieceDatasetConfig
...
def model_provider(pre_process=True, post_process=True):
    ...
    if args.use_legacy_models:
        model = synerfuse.legacy.model.BertModel(
            config=config,
